...
**❗IMPORTANTE: Caso o sistema não permita a execução de scripts por questões de segurança, rodar o seguinte comando para alterar essa permissão temporariamente antes de ativar o Ambiente Virtual:** <br>
`Set-ExecutionPolicy -Scope Process RemoteSigned` <br>
**✅ 2. Instalar as Dependências** <br>
`pip install -r requirements.txt` <br>
**✅ 3. Executar o Back-end (API)** <br>
...
•	Abra o arquivo: <br>
`frontend/index.html` (Clique duas vezes ou escolha abrir no navegador) <br>
